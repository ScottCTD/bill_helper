...
- Added the workspace terminal tool in [backend/services/agent/workspace_command.py](../../backend/services/agent/workspace_command.py) plus its catalog/arg wiring.
