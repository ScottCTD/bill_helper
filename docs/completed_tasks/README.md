...
- `2026-03-11_ios_full_app.md`: archived task for the full native iPhone app shell, onboarding/session flow, five-tab workspace expansion, and backend-backed manage/settings coverage.
