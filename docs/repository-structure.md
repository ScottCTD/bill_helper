...
- `ios/`: SwiftUI iPhone app workspace containing the onboarding-aware app shell target, shared mobile core sources, feature surfaces, extracted agent timeline/markdown support helpers, `ios/docs/` client notes, and focused API/unit tests.
