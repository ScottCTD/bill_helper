...
- assistant markdown is rendered through the shared markdown renderer and keeps list/code/blockquote spacing stable even when streamed text arrives with weak formatting
